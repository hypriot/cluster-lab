...
cp cluster-lab_images.list ${BUILD_DIR}/${PACKAGE_NAME}/etc/cluster-lab/
cp imageloader.sh ${BUILD_DIR}/${PACKAGE_NAME}/usr/local/bin/imageloader
chmod +x ${BUILD_DIR}/${PACKAGE_NAME}/usr/local/bin/imageloader
